...
from habits.views import HabitList, HabitCreateView, HabitDetail, HabitUpdate, HabitDelete, PublishedHabitList

app_name = HabitsConfig.name

urlpatterns = [
    path('', PublishedHabitList.as_view(), name='published_list'),
